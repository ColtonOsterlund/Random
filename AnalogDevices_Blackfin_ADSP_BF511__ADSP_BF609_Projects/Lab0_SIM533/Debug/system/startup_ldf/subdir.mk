...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn -file-attr ProjectName="Lab0_SIM533" -proc ADSP-BF533 -si-revision any -g -DCORE0 -D_DEBUG @includes-f7427bf6c72b64c5107f6d9da54a8ab6.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
