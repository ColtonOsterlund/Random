...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn -file-attr ProjectName="CoffeepotAssignmentMultiplePots" -proc ADSP-BF609 -si-revision any -g -D_DEBUG -DCORE0 @includes-a98f4565a5dc3d6700a2ceda4a6c069a.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
