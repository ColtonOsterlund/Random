...
public class SearchNameBtnListener implements ActionListener{
	/**
	 ...
	 */
	public SearchNameBtnListener(ClientGUIController guiController, ClientCommunicationController comController) {
		this.guiController = guiController;
		this.comController = comController;
	}
	
	/**
	 * This method sends the string 3 to the server, then sends the Name of the item being searched for
